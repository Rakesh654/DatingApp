...
namespace API.Controllers
{
    ...
    public class AppUsersController : BaseApiController
    {
        ...
        public async Task<ActionResult<IEnumerable<MemberDto>>> GetUsers([FromQuery]UserParams userParams)
        {
            ...
            userParams.CurrentUser = user.Result.UserName;

            if(string.IsNullOrEmpty(userParams.Gender))
            userParams.Gender = user.Result.Gender == "male" ? "female" : "male";
        ...
        public async Task<ActionResult<PhotoDto>> AddPhoto(IFormFile file)
        {
            ...
            {
                return CreatedAtRoute("GetUser", new {username = user.Result.UserName} , _mapper.Map<PhotoDto>(photo));
            }
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            var photo = user.Result.Photos.FirstOrDefault(x=> x.Id == photoId);
